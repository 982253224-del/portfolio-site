    ...
    <footer data-cmp="Footer" className="w-full py-8 border-t border-border bg-background">
      <div className="max-w-[1440px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-muted-foreground text-sm">
          © {new Date().getFullYear()} <EditableText storageKey="footer.copyrightName" fallback="Alex Zhang" className="bg-transparent" />. <EditableText storageKey="footer.copyrightSuffix" fallback="All rights reserved." className="bg-transparent" />
        </div>
